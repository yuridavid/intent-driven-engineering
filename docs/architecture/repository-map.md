...
|---|---|---|---|---|
| `ide-bok/architecture/` | Canonical cross-cutting Engineering Capability architecture. | Constitution, Concept Model, Knowledge Taxonomy, architecture review, and governance decision GOV-005. | IDE-BoK Steward; Repository Owner for final governance authority. | Sole canonical location for Engineering Capability architecture. Version 1.0 is the approved baseline for Task 1 and future capabilities. |
